            ...
            <div className="col-md-6 wrap ftco-animate">
              <div className="about-desc">
                <h1
                  className="bold-text"
                  style={{
                    transform: `translateY(${ParallaxScrolling() * -0.2}px)`,
                  }}
                >
                  {t("about_me")}
                </h1>
                <div className="p-5">
                  ...
                  <p>
                    ...
                    <a href="mailto:mohamedlamine.oubaya@gmail.com">
                      mohamedlamine.oubaya@gmail.com
                    </a>
                  </p>
                </div>
              </div>
            ...
            <div className="col-sm-8">
              <div className="education-wrapper">
                <div className="education margin-b-50">
                  ...
                  <h5>
                    <b>{t("internship3_local")}</b>
                  </h5>
                  <h6 className="font-lite">{t("internship4_length")}</h6>
                </div>
                <div className="education margin-b-50">
                  <h4>
                    <b>{t("internship3")}</b>
